  ...
  return (
    <div>
      ...
      <div className="relative">
        <div className="relative flex h-10 w-full overflow-hidden rounded-sm ring-1 ring-ink/15">
          <motion.div
            className="h-full"
          ...
          />
          {/* Línea de mayoría (50%) */}
          <div className="pointer-events-none absolute inset-y-0 left-1/2 w-0.5 -translate-x-1/2 bg-ink/85" />
        </div>
        {/* Etiqueta de mayoría */}
      ...
      <div className="mt-8 flex flex-col items-center gap-2">
        ...
        >
          <span className="text-xs text-ink/55">Diferencia</span>
          <span
          ...
          <span className="text-xs text-ink/55">votos</span>
        </div>
        <p className="text-center text-xs text-ink/50">
          Ventaja de{" "}
          <span className="font-semibold text-ink/80">{leaderLastName}</span> ·{" "}
  ...
  return (
    ...
    >
      ...
      <div>
        ...
        <div className="font-serif text-sm font-bold text-ink/85">
